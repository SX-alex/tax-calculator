...
const getData = () => {
    ...
    fetch(`https://hook.eu1.make.com/uxm6ecrkgwy0auczytc7dp3jrbvqsln3?country=${country}&marketSharesValueGrant=${marketSharesValueGrant}&exercisePrice=${exercisePrice}&marketSharesValue=${marketSharesValue}&salePrice=${salePrice}&annualIncome=${annualIncome}&checkbox=${checkbox}`)
...
treatmentToggle.addEventListener('change', function () {
    if ( treatmentToggle.checked ){
        ...
        if (calculatedCountry.toLowerCase() === 'united kingdom (csop)' && type === 'emi'){
            ...
            document.getElementById('employee-gain').textContent = data.emiFinalGainTaxCH;

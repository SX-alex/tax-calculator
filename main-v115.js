...
const getData = () => {
    ...
    fetch(`https://hook.eu2.make.com/mjy8h76g43ic2w45sk2ejjmrnqas1752?country=${country}&marketSharesValueGrant=${marketSharesValueGrant}&exercisePrice=${exercisePrice}&marketSharesValue=${marketSharesValue}&salePrice=${salePrice}&annualIncome=${annualIncome}&checkbox=${checkbox}`)

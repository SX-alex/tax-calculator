      ...
      <ul role="list" class="tax-treatment-list text is--color-neutral-900 is--caption is--regular">
        ...
        case "germany"://TOGGLE
            ...
            //SOCIAL SECURITY CONTRIBUTIONS
                  ...
                  ssc_erp_taxAmount = 0;
                  if (benefitAmountIncome < 84000) {
                      ssc_erp_taxAmount = Math.max(calculatePersentValue(benefitAmount, ssrRate), 0);
                  } else if (benefitAmountIncome > 84000) {
                      ssc_erp_taxAmount = Math.max(calculatePersentValue((84000 - annualIncomeLoc), ssrRate), 0);
                  } else if (annualIncomeLoc > 84000) {
                      ssc_erp_taxAmount = 0;
                  }
                  
                  ssc_erp_taxAmountVsop = 0;
                  if (vsopBenefitAmountIncome < 84000) {
                      ssc_erp_taxAmountVsop =  Math.max(calculatePersentValue(vsopBenefitAmount, ssrRate), 0);
                  } else if (vsopBenefitAmountIncome > 84000) {
                      ssc_erp_taxAmountVsop =  Math.max(calculatePersentValue((84000 - annualIncomeLoc), ssrRate), 0)
                  } else if (annualIncomeLoc > 84000) {
                      ssc_erp_taxAmountVsop = 0;
                  }
            
                ssc_eep_taxAmount = 0;
                  if (benefitAmountIncome < 58050) {
                      ssc_eep_taxAmount = Math.max(calculatePersentValue(benefitAmount, ssrRateE), 0);
                  } else if (benefitAmountIncome > 58050) {
                      ssc_eep_taxAmount = Math.max(calculatePersentValue((58050 - annualIncomeLoc), ssrRateE), 0);
                  } else if (annualIncomeLoc > 58050) {
                      ssc_eep_taxAmount = 0;
                  }
                  
                  ssc_eep_taxAmountVsop = 0;
                  if (vsopBenefitAmountIncome < 58050) {
                      ssc_eep_taxAmountVsop =  Math.max(calculatePersentValue(vsopBenefitAmount, ssrRateE), 0)
                  } else if (vsopBenefitAmountIncome > 58050) {
                      ssc_eep_taxAmountVsop =  Math.max(calculatePersentValue((58050 - annualIncomeLoc), ssrRateE), 0);
                  } else if (annualIncomeLoc > 58050) {
                      ssc_eep_taxAmountVsop = 0;
                  }

...
const calculateTax = () => {
    ...
    switch (selectedCountry) {
      ...
      if (benefitAmountIncome <= 78100){
       ssc_erp_taxAmount = socialTaxBases[2]*10.5/100
      }else if (annualIncomeLoc > 78100){
        ssc_erp_taxAmount = 0;
      }else if (benefitAmountIncome > 78100 && annualIncomeLoc < 78100){
       (78100 - socialTaxBases[0] ) * 10.5/100
      }
      ssc_erp_taxAmountChecked = 0;
      if (vsopBenefitAmountIncome <= 78100){
        ssc_erp_taxAmountVsop = socialTaxBases[4] * 10.5 / 100
      }else if (annualIncomeLoc > 78100){
        ssc_erp_taxAmountVsop = 0;
      }else if (vsopBenefitAmountIncome > 78100 && annualIncomeLoc < 78100){
        ssc_erp_taxAmountVsop = ( 78100 - annualIncomeLoc ) * 10.5 / 100
      }
      
      if (benefitAmountIncome <= 78100){
        ssc_eep_taxAmount = socialTaxBases[2] * 23.59 / 100;
      }else if (annualIncomeLoc > 78100){
        ssc_eep_taxAmount = 0;
      }else if (benefitAmountIncome > 78100 && annualIncomeLoc < 78100){
        ssc_eep_taxAmount = ( 78100 - annualIncomeLoc ) * 23.59 / 100;
      }
      ...
      if (annualIncomeLoc > 16065){
        ...
        ssc_eep_taxAmountVsop = socialTaxBases[4] * 23.59 / 100
      }else if (vsopBenefitAmountIncome > 78100 && annualIncomeLoc < 78100){
        ssc_eep_taxAmountVsop = ( 78100 - annualIncomeLoc ) * 23.59 / 100;
      }
      ...
      console.log('socialTaxBases', socialTaxBases[4])
...
function updateData() {
    ...
    valSocialSecurity = isTreatmentToggle ? ssc_erp_taxAmountChecked : ssc_erp_taxAmount;
    valSocialSecurityEmployer = isTreatmentToggle ? ssc_eep_taxAmountChecked : ssc_eep_taxAmount;

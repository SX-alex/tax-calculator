    ...
    switch (selectedCountry) {
      ...
      <ul role="list" class="tax-treatment-list text is--color-neutral-900 is--caption is--regular">
        ...
        case "belgium":
	        ...
	        <div>Capital gains are not taxable for private individuals resident in Belgium if the selling the shares is not part of their business activity.</div>
            ...
            treatmentBody.innerHTML = `
	        <ul role="list" class="tax-treatment-list text is--color-neutral-900 is--caption is--regular">
              <li>Options must be accepted in writing within 60 days from the offer to benefit from tax relief. Then, the only tax point will be at grant.</li>
              <li>The minimal tax amount can be applied at the time of grant if all the following conditions are met:
                  <ul role="list" class="tax-treatment-sublist">
                    ...
                    <li>the options are for the shares of the employer or a group company</li>
                  </ul>
	          </li>
	        </ul>`
